    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-background">
      ...
      <div className="relative hidden md:flex flex-col justify-center items-center p-8 md:p-12 bg-gradient-to-bl from-primary/80 via-accent/60 to-secondary/80 animate-gradient-move overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 w-full">
          ...
          {/* Illustration */}
          <motion.img
            src="/images/join-ai.svg"
            alt="Join AI Illustration"
          ...
          <AnimatePresence mode="wait">
            ...
            >
              Join the global movement teaching AI to think smarter — and get paid doing it.
            </motion.div>
          </AnimatePresence>
          {/* Rotating Benefits */}
          <div className="mt-6">
      ...
      <div className="flex flex-col min-h-screen justify-center items-center p-4 md:p-12 bg-background/80 relative">
        ...
        >
          <div className="mb-2">
            <h2 className="font-heading text-2xl font-bold text-primary mb-1">Create your NexusLoop account</h2>
            <p className="text-muted-foreground text-sm">Sign up to start working on tasks and earning rewards.</p>
          </div>
          <form className="flex flex-col gap-4">
            ...
            <div>
              ...
              />
              <div className="text-xs text-muted-foreground mt-1">Must be at least 8 characters, include a number and a symbol.</div>
            </div>
            <div>
          ...
          <div className="text-xs text-muted-foreground text-center mt-4">
            ...
            <Link href="/terms" className="hover:underline">Terms</Link> and <Link href="/privacy" className="hover:underline">Privacy Policy</Link>.
          </div>
        </motion.div>
        {/* Footer */}
...
// CSS for .animate-gradient-move and .animate-blob should be added to global styles for full effect. 